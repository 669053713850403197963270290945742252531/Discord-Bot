...
class Url(commands.Cog):
    ...
    @app_commands.describe(
        ...
        title="Title, all providers. E-Z requires this or `file` (filename becomes title). Pastebin: optional.",
        description="Description, all providers except pastey.gg/Pastebin (they ignore it). Required by E-Z.",
        access_key="Optional -- pastee.dev/Pastebin: use your own account. pastey.gg: sets a view password.",
        visibility="Optional -- who can view this. Rubiš/Pastebin: public (default), Pastebin also unlisted/private.",
        expires="Optional -- when this expires. pastee.dev/pastey.gg/Pastebin only; see error for accepted formats.",
        ...
        folder_key="Optional -- Pastebin only. The folder's actual key (not its name). Needs access_key.",
        file1="Optional -- a 2nd file. Its filename sets title/language. pastee.dev or pastey.gg only.",
        file2="Optional -- a 3rd file. Its filename sets title/language. pastee.dev or pastey.gg only.",
        file3="Optional -- a 4th file. Its filename sets title/language. pastee.dev or pastey.gg only.",
        file4="Optional -- a 5th file. Its filename sets title/language. pastee.dev or pastey.gg only.",
    )
