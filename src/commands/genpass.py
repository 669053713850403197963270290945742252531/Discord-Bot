...
class GenPass(commands.Cog):
    ...
    @app_commands.describe(
        ...
        extended_charset="Add foreign-language letters/symbols (accented Latin, Greek, Cyrillic, currency) too (random mode).",
        exclude_ambiguous="Remove easily-confused characters like 0/O, l/1/I, and | (random mode).",
        easy_to_read="Simplify to unambiguous letters+digits only, no symbols/extended, for easier typing (random mode).",
